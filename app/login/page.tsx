...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <AppSidebar />
      <div className="flex-1 ml-80 flex items-center justify-center p-4">
        <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-gradient-to-br from-sky-50 to-sky-100 border-sky-200 shadow-xl">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-xl font-bold text-sky-900">Retailer Dashboard Demo</CardTitle>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="bg-white/50 rounded-lg p-3 text-center">
                    <div className="font-bold text-sky-800">ZMW 1.1M+</div>
                    <div className="text-sky-600">Revenue</div>
                  </div>
                  <div className="bg-white/50 rounded-lg p-3 text-center">
                    <div className="font-bold text-sky-800">2,472</div>
                    <div className="text-sky-600">Orders</div>
                  </div>
                  <div className="bg-white/50 rounded-lg p-3 text-center">
                    <div className="font-bold text-sky-800">3,847</div>
                    <div className="text-sky-600">Products</div>
                  </div>
                  <div className="bg-white/50 rounded-lg p-3 text-center">
                    <div className="font-bold text-sky-800">12,429</div>
                    <div className="text-sky-600">Customers</div>
                  </div>
                </div>
